<?php
    include 'conecta.php';
    $funcionario = mysqli_query($conn, "SELECT * FROM funcionario WHERE data_vencimento BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 3 DAY)");
    ...
    else
    {
        ...
        echo "<br/>";
        echo "<center><h2><b>NÃO EXISTE REGISTROS DE ENTREGA QUE ESTÃO PRESTES A VENCER</b></h2></center>";
    }
?>  