<?php
    include 'conecta.php';
    $funcionario = mysqli_query($conn, "SELECT * FROM funcionario WHERE data_vencimento < CURDATE()");
    ...
    else
    {
        ...
        echo "<br/>";
        echo "<center><h2><b>NÃO EXISTE REGISTROS DE ENTREGA VENCIDAS</b></h2></center>";
    }
?>  